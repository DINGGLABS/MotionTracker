/** ===========================================================
 *  test MotionTracker V01
 *
 * \file       test_MotionTracker_V01
 * \author     jh
 * \date       xx.06.2015  
 * \subversion -00
 *
...
void setup()
{
  ...
  delay(1000);
  Serial.println("-------------------------");
  Serial.println("sensor test MotionTracker_V01");
...
{ 
  ...
  Serial.print("dt: "); Serial.print(t - t_alt); Serial.println(" us");
  t_alt = t;
